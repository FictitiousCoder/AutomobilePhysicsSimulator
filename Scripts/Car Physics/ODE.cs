using System;
/*The ODE-class represents and ODE to be solved. Physical objects, such as projectiles,
 *cars, boats, etc. can extend this class and use the ODE-Solver to sole its equations.*/
...
public abstract class ODE
{
  ...
  //These properties access the value of the numEqns and s fields.
  public int NumEqns {
    get {
      return numEqns;
    }
