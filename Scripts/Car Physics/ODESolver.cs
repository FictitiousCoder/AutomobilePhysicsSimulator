using System;
/*The ODE-solver is, as the name suggests, made to solve ODEs. More specifcially,
 *it's a fourth-order runge-kutta ODE solver. Its values are filled by the ones
 *of an ODE-object or an object that extends the ODE-class.*/
